...
const emit = defineEmits(["update:isDialogVisible", "deleteUnitConversion"]);
...
<template>
    <VDialog max-width="450" :model-value="props.isDialogVisible" @update:model-value="dialogVisibleUpdate">
        <VCard class="pa-sm-11 pa-3">
            ...
            <VCardText class="pt-5">
                ...
                <!-- 👉 Form -->
                <VForm class="mt-4" @submit.prevent="deleteUnitConversion">
                    <VRow>
                        <!-- 👉 First Name -->
                        <VCol cols="12">
                            <p>
                                ¿Estas seguro de eliminar la conversión :
                                {{ props.unitConversionSelected.unit_to.name }}?
                            </p>
                        </VCol>
