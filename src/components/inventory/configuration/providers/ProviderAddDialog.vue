            ...
            <VCardText class="pt-5">
                ...
                <VForm class="mt-4" @submit.prevent="store">
                    <VRow>
                        ...
                        <VCol cols="6">
                            <VTextField v-model="phone" type="number" label="Telefono" placeholder="Example: 0999999999" />
                        </VCol>

                        <VCol cols="12">
                            <VTextField v-model="ruc" type="number" label="Ruc" placeholder="Example: 1793xxxxxx001" />
                        </VCol>
