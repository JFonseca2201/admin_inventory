      ...
      <VCardText class="pt-5">
        ...
        <VForm class="mt-4" @submit.prevent="update">
          <VRow>
            <!-- 👉 First Name -->
            <VCol cols="12">
              <VTextField v-model="full_name" label="Nombre del Proveedor" placeholder="Example: Jose" />
            </VCol>
            ...
            <VCol cols="8">
              <VTextField v-model="ruc" type="number" label="Ruc" placeholder="Example: 9999999" />
            </VCol>
            ...
            <VCol cols="6">
              ...
              ]" item-title="name" item-value="id" v-model="state" label="Estado" placeholder="Select Item"
                eager />
            </VCol>
