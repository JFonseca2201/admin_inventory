      ...
      <VCardText class="pt-5">
        ...
        <VForm class="mt-4" @submit.prevent="update">
          <VRow>
            <!-- 👉 First Name -->
            <VCol cols="6">
              <VTextField v-model="name" label="Nombre" placeholder="Example: Jose" />
            </VCol>
            <VCol cols="6">
              <VTextField v-model="surname" label="Apellido" placeholder="Example: Mendoza" />
            </VCol>
            ...
            <VCol cols="6">
              <VTextField v-model="phone" type="number" label="Telefono" placeholder="Example: 9999999" />
            </VCol>
            ...
            <VCol cols="6">
              <VTextField v-model="n_document" type="number" label="N° de documento" placeholder="Example: 9999999" />
            </VCol>
            ...
            <VCol cols="6">
              <VSelect :items="props.sucursales" item-title="name" item-value="id" v-model="sucursale_id"
