            ...
            <VCardText class="pt-5">
                ...
                <VForm class="mt-4" @submit.prevent="update">
                    <VRow>
                        <!-- 👉 First Name -->
                        <VCol cols="12">
                            <VSelect :items="['EFECTIVO', 'DEPOSITO', 'TRANSFERENCIA', 'DE UNA']"
                                v-model="method_payment" label="Metodo de Pago" placeholder="Select Item" eager />
                        </VCol>
                        <VCol cols="12">
                            <VTextField label="Monto" type="number" v-model="amount" placeholder="" prefix="$" />
                        </VCol>
