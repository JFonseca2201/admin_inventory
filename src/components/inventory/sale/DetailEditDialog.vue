...
onMounted(() => {
    ...
    price_unit.value = parseFloat(props.saleDetailSelected.price).toFixed(2);
    discount.value = parseFloat(props.saleDetailSelected.discount).toFixed(2);
            ...
            <VCardText class="pt-5">
                ...
                <VForm class="mt-4" @submit.prevent="update">
                    <VRow>
                        ...
                        <VCol cols="6" md="6">
                            <VTextField label="Precio Unitario" prefix="$" type="number" v-model="price_unit"
                                placeholder="" />
                        </VCol>

                        <VCol cols="6" md="6">
                            <VTextField label="Descuento" prefix="$" type="number" v-model="discount" placeholder="" />
                        </VCol>
