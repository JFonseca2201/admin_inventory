            ...
            <VCardText class="pt-5">
                <div class="text-center pb-6">
                    <h4 class="text-h4 mb-2">
                        Delete Sale: {{ props.selectedRefoundProduct.id }}
                    </h4>
                </div>

                <!-- 👉 Form -->
                <VForm class="mt-4" @submit.prevent="deleteRefoundProduct">
                    <VRow>
                        <!-- 👉 First Name -->
                        <VCol cols="12">
                            <p>¿Estas seguro de eliminar la devolución {{ props.selectedRefoundProduct.product.title }}?
                            </p>
                        </VCol>
