            ...
            <VCardText class="pt-5">
                ...
                <VForm class="mt-4" @submit.prevent="store">
                    <VRow>
                        ...
                        <VCol cols="4">
                            <VTextField label="N° Venta" placeholder="94454" type="number" v-model="sale_id" />
                        </VCol>

                        <VCol cols="4">
                            <VBtn color="info" class="mx-1" prepend-icon="ri-search-2-line" @click="searchSale()">
                        ...
                        <VCol cols="12" v-if="sale">
                            <VRadioGroup v-model="sale_detail_id">
                                <VTable>
                                    ...
                                    <tbody>
                                        <tr v-for="sale_detail in sale.sale_details" :key="sale_detail.id">
                                            <td>
                                                <VRadio label="" :value="sale_detail.id"
