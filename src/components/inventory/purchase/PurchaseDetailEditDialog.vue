                    ...
                    <VRow>
                        ...
                        <VCol cols="4" md="4">
                            <VTextField label="Cantidad" type="number" v-model="quantity"
                                :disabled="props.purchaseDetailSelected.state != 1 ? true : false" placeholder="" />
                        </VCol>
                        <VCol cols="4">
                            <VTextField label="Precio Unitario" type="number" v-model="price_unit" placeholder=""
                                prefix="$" />
                        </VCol>
                        ...
                        <VCol cols="12" class="d-flex flex-wrap justify-center gap-4">
                            <VBtn type="submit">
                                <VIcon icon="ri-checkbox-circle-line" />&nbsp; Editar
                            </VBtn>

                            <VBtn color="secondary" variant="outlined" @click="onFormReset">
                                <VIcon icon="ri-close-circle-line" />&nbsp; Cancelar
                            </VBtn>
                        </VCol>
                    </VRow>
                </VForm>
