    ...
    <VDialog max-width="650" :model-value="props.isDialogVisible" @update:model-value="dialogVisibleUpdate">
        <VCard class="pa-sm-11 pa-3">
            ...
            <VCardText class="pt-5">
                ...
                <!-- 👉 Form -->
                <VForm class="mt-4" @submit.prevent="deletePurchaseDetail">
                    <VRow>
                        <!-- 👉 First Name -->
                        <VCol cols="12">
                            <p>¿Estas seguro de eliminar el Detallado : {{ props.purchaseDetailSelected.product.title
                                }}?
                            </p>
                        </VCol>
                        ...
                        <VCol cols="12" class="d-flex flex-wrap justify-center gap-4">
                            <VBtn type="submit" color="error">
                                <VIcon icon="ri-checkbox-circle-line" />&nbsp; Eliminar
                            </VBtn>
