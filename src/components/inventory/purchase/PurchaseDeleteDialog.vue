            ...
            <VCardText class="pt-5">
                <div class="text-center pb-6">
                    <h4 class="text-h4 mb-2">
                        Delete Purchase: {{ props.purchaseSelected.id }}
                    </h4>
                </div>

                <!-- 👉 Form -->
                <VForm class="mt-4" @submit.prevent="deletePurchase">
                    <VRow>
                        <!-- 👉 First Name -->
                        <VCol cols="12">
                            <p>¿Estas seguro de eliminar la compra {{ props.purchaseSelected.id }}?</p>
                        </VCol>
