      ...
      >
        <VCardItem>
          ...
          <VCardSubtitle class="text-white">
            Total ${{ item.sales_total_sucursale }} Sales

            <div v-if="item.variation_percentage_sucursale>=0" class="d-inline-block text-success font-weight-medium">
              <div class="d-flex align-center">
                +{{ item.variation_percentage_sucursale }}
                <VIcon
            ...
            <div v-if="item.variation_percentage_sucursale<0" class="d-inline-block text-danger font-weight-medium">
              <div class="d-flex align-center">
                -{{ item.variation_percentage_sucursale }}
                <VIcon
