...
const year_list = ref(['2024','2025','2026','2027','2028','2029','2030','2031','2032']);
const year_selected=ref(new Date().getFullYear()+"");
const vuetifyTheme = useTheme()

 

const sales_for_mont_year=async()=>{
  try {
    ...
    const resp = await $api("kpi/sales_x_month_of_year", {
        ...
        resp.sales_x_month_of_year_current.forEach(element=>{
