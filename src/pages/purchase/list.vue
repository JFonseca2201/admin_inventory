            ...
            <VCardText>
                <VRow class="">
                    <VCol cols="10">
                        <VRow>
                            <VCol cols="3">
                                <VTextField placeholder="Search N° Purchase" density="compact" class="me-3"
                            ...
                            <VCol cols="3">
                                <VSelect placeholder="Select" label="Proveedores" :items="providers"
            ...
            <VTable>
                ...
                <tbody class="text-uppercase">
                    <tr v-for="purchase in list_purchases" :key="purchase.id">
                        ...
                        <td>
                            <VChip color="error" v-if="purchase.state == 1"> Solicitado </VChip>
                            <VChip color="warning" v-if="purchase.state == 2"> Parcial </VChip>
                            <VChip color="primary" v-if="purchase.state == 3"> Completo </VChip>
                        </td>
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <IconBtn v-if="purchase.state == 1" size="small" @click="deleteItem(purchase)">
