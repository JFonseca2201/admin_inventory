...
const purchaseDetailEdit = (DATA) => {
    ...
    let INDEX = purchase_details.value.findIndex((detail) => detail.id == PurchaseDetalUpdate.id);
                        ...
                        <VRow>
                            ...
                            <VCol cols="3">
                                <VSelect v-model="warehouse_id" :items="warehouses" label="Almacen" item-title="name"
                                    item-value="id" placeholder="Select Almacen" eager disabled />
                            </VCol>
                            <VCol cols="3">
                    ...
                    <VTable style="border: 1px solid #ccc">
                        ...
                        <tbody>
                            <tr v-for="(purchase_detail, index) in purchase_details" :key="index">
                                ...
                                <td>
                                    <VChip color="error" v-if="purchase_detail.state == 1">PENDIENTE
                                    </VChip>
                                    <VChip color="primary" v-if="purchase_detail.state == 2">COMPLETO
                                    </VChip>
                                </td>
                                ...
                                <td class="d-flex align-center">
                                    ...
                                    <IconBtn v-if="purchase_detail.state == 1" size="small"
