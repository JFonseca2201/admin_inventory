...
<template>
    <div>
            ...
            <VCardText>
                <VRow class="">
                    <VCol cols="10">
                        <VRow>
                            <VCol cols="3">
                                <VTextField placeholder="Search N° de registro" density="compact" class="me-3"
                                    v-model="conversion_id" @keyup.enter="list" />
                            </VCol>
                        ...
                        <VRow>
                            ...
                            <VCol cols="3">
                                <VSelect :items="units" item-title="name" item-value="id" placeholder="Select"
                                    v-model="unit_start_id" label="Unidad inicial" />
                            </VCol>
                            <VCol cols="3">
                                <VSelect :items="units" item-title="name" item-value="id" placeholder="Select"
                                    v-model="unit_end_id" label="Unidade final" />
                            </VCol>
                    ...
                    <tr v-for="conversion in list_conversions" :key="conversion.id">
                        ...
                        <td>
                            <div class="d-flex align-center">
                                <VAvatar size="32" :color="conversion.product.imagen ? '' : 'primary'"
                                    :class="conversion.product.imagen ? '' : 'v-avatar-light-bg primary--text'"
                                    :variant="!conversion.product.imagen ? 'tonal' : undefined">
                                    <VImg v-if="conversion.product.imagen" :src="conversion.product.imagen" />
        ...
        <ConversionAddDialog v-if="warehouses.length > 0" 
        ...
        <ConversionDeleteDialog v-if="selected_conversion_delete && isConversionDeleteDialogVisible"
            v-model:isDialogVisible="isConversionDeleteDialogVisible"
            :conversionSelected="selected_conversion_delete" @deleteConversion="conversionDelete">
