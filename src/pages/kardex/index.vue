...
const year_list = ref(['2023','2024','2025','2026','2027','2028', '2029', '2030', '2031', '2032', '2033' ]);
            ...
            <VCardText>
                <VRow class="">
                    <VCol cols="12">
                        <VRow>                                                       
                        <VCol cols="2">
                                <VSelect :items="year_list"  placeholder="Year Select"
                                    v-model="year_selected" label="Año" />
                            </VCol>

                            <VCol cols="2">
                                <VSelect :items="month_list" item-title="name" item-value="id"  placeholder="Select"
                                    v-model="month_selected" label="Mes" />
                            </VCol>
                            ...
                            <VCol cols="2" class="d-flex gap-1">
                                <VBtn color="info" class="mx-1" prepend-icon="ri-search-2-line" @click="kardex()">
