...
<template>
  <div>
      ...
      <VCardText>
        <VRow class="justify-space-between">
          ...
          <VCol cols="2" class="text-end">
            <VBtn
              @click="
                isWarehouseAddDialogVisible = !isWarehouseAddDialogVisible
              "
            >
              Add Warehouse
    ...
    ></WarehouseAddDialog>
    <WarehouseEditDialog
      v-if="warehouse_selected_edit && isWarehouseEditDialogVisible"
      :sucursales="list_sucursales"
      v-model:isDialogVisible="isWarehouseEditDialogVisible"
      :warehouseSelected="warehouse_selected_edit"
      @editWarehouse="addEditWarehouse"
    ></WarehouseEditDialog>
    <WarehouseDeleteDialog
      v-if="warehouse_selected_delete && isWarehouseDeleteDialogVisible"
      v-model:isDialogVisible="isWarehouseDeleteDialogVisible"
      :warehouseSelected="warehouse_selected_delete"
