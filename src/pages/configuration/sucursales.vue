...
<template>
  <div>
      ...
      <VCardText>
        <VRow class="justify-space-between">
          ...
          <VCol cols="2" class="text-end">
            <VBtn
              @click="isSucursalAddDialogVisible = !isSucursalAddDialogVisible"
            >
              Add Sucursal
    ...
    <SucursalAddDialog
      v-model:isDialogVisible="isSucursalAddDialogVisible"
      @addSucursal="addNewSucursal"
    ></SucursalAddDialog>
    <SucursalEditDialog
      v-if="sucursal_selected_edit && isSucursalEditDialogVisible"
      v-model:isDialogVisible="isSucursalEditDialogVisible"
      :sucursalSelected="sucursal_selected_edit"
      @editSucursal="addEditSucursal"
    ></SucursalEditDialog>
    <SucursalDeleteDialog
      v-if="sucursal_selected_delete && isSucursalDeleteDialogVisible"
      v-model:isDialogVisible="isSucursalDeleteDialogVisible"
      :sucursalSelected="sucursal_selected_delete"
      @deleteSucursal="addDeleteSucursal"
    ></SucursalDeleteDialog>
  </div>
</template>
