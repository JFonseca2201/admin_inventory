...
<template>
  <div>
    ...
    <UnitEditDialog
      ...
      :unitSelected="unit_selected_edit"
      @editUnit="addEditUnit"
    ></UnitEditDialog>
    <UnitDeleteDialog
      v-if="unit_selected_delete && isUnitDeleteDialogVisible"
      v-model:isDialogVisible="isUnitDeleteDialogVisible"
      :unitSelected="unit_selected_delete"
      @deleteUnit="addDeleteUnit"
    ></UnitDeleteDialog>
    <UnitConversionAddDialog
      v-if="unit_selected_conversion && isUnitConversionAddDialogVisible"
      v-model:isDialogVisible="isUnitConversionAddDialogVisible"
      :units="list_units"
      :unitSelected="unit_selected_conversion"
    >
    </UnitConversionAddDialog>
    <!--   -->
  </div>
