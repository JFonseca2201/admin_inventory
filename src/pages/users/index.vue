...
<template>
  <div>
    ...
    ></UserAddDialog>
    <UserEditDialog
      v-if="user_selected_edit && isUserEditDialogVisible"
      :sucursales="sucursales"
      :roles="roles"
      v-model:isDialogVisible="isUserEditDialogVisible"
      :selectedUser="user_selected_edit"
      @editUser="addEditUser"
    ></UserEditDialog>
    <UserDeleteDialog
      v-if="user_selected_delete && isUserDeleteDialogVisible"
      v-model:isDialogVisible="isUserDeleteDialogVisible"
      :userSelected="user_selected_delete"
      @deleteUser="addDeleteUser"
    ></UserDeleteDialog>
  </div>
</template>
